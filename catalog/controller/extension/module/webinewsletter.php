...
class ControllerExtensionModuleWebinewsletter extends Controller {
	...
	public function index($setting) {
		...
		$config_theme = $this->config->get('theme_renoxa_directory');
		...
		// } else {
		// 	$this->document->addStyle('catalog/view/theme/renoxa/stylesheet/webinewsletter.css');
		// }
		...
		$this->mdata['mode']        = isset($setting['displaymode']) ? $setting['displaymode'] : "renoxa";
